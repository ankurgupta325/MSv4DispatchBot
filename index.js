...
const { CustomPromptDialog } = require('./dialogs/customPromptBot');
...
//const customPromptDialog = new CustomPromptDialog(userState);

const bot = new DispatchBot(conversationState, userState);
