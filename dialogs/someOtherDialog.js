...
const SOME_OTHER_DIALOG = 'SOME_OTHER_DIALOG';
...
class SomeOtherDialog extends ComponentDialog {
    ...
    async loopStep(stepContext) {
        ...
        if (done || list.length > 1) {
            ...
            return await stepContext.replaceDialog(SomeOtherDialog, list);
        }
    }
}

module.exports.SomeOtherDialog = SomeOtherDialog;
module.exports.SOME_OTHER_DIALOG = SOME_OTHER_DIALOG;